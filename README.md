...
/set logger.file.rotation_size_max          "100m"
...
- Highlight monitor *(This can completely replace [highmon.pl](https://weechat.org/scripts/source/highmon.pl.html/))*
```
...
/server add ezbake    gem.elixir.sh/6697             -tls
...
/server add soldierx  irc.soldierx.com/6697          -tls
...
/server add wigle     wigle.net/6668                 -tls
...
/set irc.server.blackcatz.autojoin   #blackcatz
...
/set irc.server.ezbake.autojoin      #ezbake
...
/set irc.server.supernets.capabilities account-tag,batch,message-tags,unrealircd.org/json-log,server-time,labeled-response
...
###### Mirrors for this repository: [SuperNETs](https://git.supernets.org/acidvegas/weechat) � [GitHub](https://github.com/acidvegas/weechat) � [GitLab](https://gitlab.com/acidvegas/weechat) � [Codeberg](https://codeberg.org/acidvegas/weechat)